...
class AlgorithmRPCMessageConverter:
    ...
    def __algorithm_data_message_to_model(cls,
        ...
        return AlgorithmDataMessageModel(
            ...
            timestamp_ms=algorithm_data_message.timestamp_ms,
    ...
    def __algorithm_report_message_to_model(
        ...
        return AlgorithmReportMessageModel(
            timestamp_ms=algorithm_report_message.timestamp_ms,
            ...
            CommonMessageConverter.protobuf_to_model(algorithm_report_message.dataPackage)
            if package_name == "dataPackage" else
    ...
    def __algorithm_report_model_to_package_pb(
        ...
        algorithm_report_message_pb = AlgorithmReportMessage_pb2(timestamp_ms=algorithm_report_message.timestamp_ms)
        ...
        elif isinstance(algorithm_report_message.package, DataPackageModel):
            algorithm_report_message_pb.dataPackage.CopyFrom(
                CommonMessageConverter.model_to_protobuf(algorithm_report_message.package))
