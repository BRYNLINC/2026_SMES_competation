...
from Common.model.CommonMessageModel import DataPackageModel
...
class ChallengeSSVEP(ChallengeInterface):
    ...
    async def receive_message(self, algorithm_data_message_model: AlgorithmDataMessageModel) \
        ...
        if isinstance(algorithm_data_message_model.package, DataPackageModel):
            pass
        else:
            logger.info(f"receive_message{algorithm_data_message_model.package}")
    ...
    async def receive_algorithm_config(self, algorithm_config: dict[str, Union[str, dict]]):
        logger.info(f"receive_algorithm_config{algorithm_config}")
    ...
    async def get_score(self) -> list[ScorePackageModel]:
        if self.is_closed:
            return [ScorePackageModel(show_text="test", score=random.random(), trial_time=random.random(),
                                      trial_id=str(1), block_id='0', subject_id='0'),
                    ScorePackageModel(show_text="test", score=random.random(), trial_time=random.random(),
                                      trial_id=str(2), block_id='0', subject_id='0'),
                    ScorePackageModel(show_text="test", score=random.random(), trial_time=random.random(),
                                      trial_id=str(3), block_id='0', subject_id='0'),
                    ScorePackageModel(show_text="test", score=random.random(), trial_time=random.random(),
                                      trial_id=str(4), block_id='0', subject_id='0'),
                    ScorePackageModel(show_text="test", score=random.random(), trial_time=random.random(),
                                      trial_id=str(5), block_id='0', subject_id='0'),
                    ScorePackageModel(show_text="test", score=random.random(), trial_time=random.random(),
                                      trial_id=str(6), block_id='0', subject_id='0')
                    ]
        # 返回当前block成绩
        return [ScorePackageModel(show_text="test", score=random.random(), trial_time=random.random(),
