...
from Algorithm.service.interface.ServiceManagerInterface import CoreControllerInterface, BusinessManagerInterface
...
class AlgorithmRPCServiceControlServer(AlgorithmRPCServiceControlServicer):
    ...
    @inject
    def __init__(self, business_manager: BusinessManagerInterface, core_controller: CoreControllerInterface):
    ...
    async def getConfig(self, request: EmptyMessage, context) -> StringMessage:
        config_dict = await self.__business_manager.get_config()
