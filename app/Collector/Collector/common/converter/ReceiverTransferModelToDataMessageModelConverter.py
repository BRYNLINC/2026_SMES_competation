...
from Collector.receiver.model.ReceiverTransferModel import ControlTransferModel
...
class ReceiverTransferModelToDataMessageModelConverter:
    ...
    def convert(cls, transfer_model: Union[
        ...
        elif isinstance(transfer_model, ControlTransferModel):
            return DataMessageModel(
                package=ControlPackageModel(end_flag=transfer_model.end_flag)
            )
        else:
