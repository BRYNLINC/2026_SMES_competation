...
class ComponentFrameworkManager(ComponentFrameworkManagerInterface):
    ...
    async def startup(self, component_startup_configuration: ComponentStartupConfigurationModel) -> StatusEnum:
        """启动"""
        # component_startup_configuration = ComponentStartupConfigurationModel(server_address=component_startup_configuration.server_address,
        #                                                                      server_port=component_startup_configuration.server_port,
